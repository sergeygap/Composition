...
import com.gap.composition.data.GameRepositoryImpl
import com.gap.composition.domain.entity.GameResult
...
import com.gap.composition.domain.usecases.GenerateQuestionUseCase
import com.gap.composition.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun calculatePercentOfRightAnswers(): Int {
        return ((countOfRightAnswer / countOfRightAnswer.toDouble()) * 100).toInt()
    }
